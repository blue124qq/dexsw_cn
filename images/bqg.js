...
if(/Android|Windows Phone|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)){
    ...
    if (url.match(/\/\/www\.xs5200\.com\//)) { Go('http://m.xs5200.com/'); }

    id = url.match(/\/(\d+)_(\d+)\/(\d+).html/);
    if (id){Go('http://m.xs5200.com/'+id[1]+'/' +id[2]+'/' + id[3] + '.html');}
    else if (url.match(/\/(\d+)_(\d+)\//)){
	    id = url.match(/\/(\d+)_(\d+)\//);
	    Go('http://m.xs5200.com/book/' +id[2]+'/');
	}
    else if (url.match(/\/txt\/(\d+)\//)){
	    id = url.match(/\/txt\/(\d+)\//);
	    Go('http://m.xs5200.com/txt/' +id[1]+'/');
	}
...
//document.writeln('<div style="position:fixed;bottom:10px;left:10px"><a href="http://pic.ting56.com/apk/firstvideo.4.5.1.100102.apk"><img style="width:140%;" src="http://www.xs5200.com/images/fv.jpg" alt="apk download"></a></div>');
function login(){
var userName = getCookie("username");
document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><div class=\"ywtop_sethome\"><a href=\"/zhuomian.php\">将小说5200快捷键保存到桌面</a></div>");
document.writeln("		<div class=\"ywtop_addfavorite\"><a href=\"#\" onclick=\"javascript:window.external.addFavorite(\'http://www.xs5200.com\',\'小说5200_书友最值得收藏的网络小说阅读网\')\">收藏小说5200</a></div>");
...
function footer(){
// document.writeln("<p>本站所收录<a href=http://www.xs5200.com/>小说</a>、社区话题、书库评论及本站所做之广告均属其个人行为，与本站立场无关！</p>");
// document.writeln("<p>本站所有的作品，图书，资料均为网友更新，如果侵犯了您的权利，请与本站联系，本站将立刻删除。</p>");
// document.writeln("<p>&copy;2018 xs5200.com <a href=http://www.xs5200.com/>全本小说</a>5200 </p>");
}
function read_panel(){
	bqg_panel();
}
...
function bqg_panel(){
	search_from();
	document.writeln('<div class="userpanel"><p><font color="red">留言：</font><a >通过邮件</a>、<a href="/newmessage.php?tosys=1" >站内短信</a></p></p><a target="_blank" href="/jifen.html">积分规则</a>&nbsp;&nbsp;<a target="_blank" href="/dns.html">解决跳到别的站</a></p></div>');
}

function search_from(){
	document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"/modules/article/search.php\" id=\"sform\"><input type=\"hidden\" name=\"s\" value=\"10362325638345863231\"><input type=\"text\" value=\"可搜书名和作者，请您少字也别输错字。\" name=\"q\" class=\"search\" id=\"wd\" baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>"); 
	// document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"https://zhannei.baidu.com/cse/search\" id=\"sform\" target=\"_blank\"><input type=\"hidden\" name=\"s\" value=\"10362325638345863231\"><input type=\"text\" value=\"可搜书名和作者，请您少字也别输错字。\" name=\"q\" class=\"search\" id=\"wd\" baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>"); 
}
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?c532d8c5aff325b986299241d6bfa9db";
